...
const StateGraph = (props) => {
    ...
    return (
        <svg width="600" height="400" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="263" y="205" fill="black" font-size="15" font-weight="bold">Visualizing</text>
            <circle className="ex-circle" cx="550" cy="200" r="40" stroke="black" stroke-width="0" fill="#3A6B35" />
            <text x="523" y="205" fill="black" font-size="15" font-weight="bold">Exercise</text>
        </svg>
    );
